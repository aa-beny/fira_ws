...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'launch'), ['launch/visual_launch.py']),
        # (os.path.join('share', package_name, 'launch'), ['launch/visual_launch.py']), # 將 'your_launch_file.launch.py' 替換為實際檔案名
    # 安裝其他資源文件（如有）
